                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <p className="text-sm text-secondary mb-4">
                            Vietnam's leading online movie ticket booking platform
                        </p>

                        {/* Social Media */}
                        <div className="mb-6">
                            <h4 className="font-semibold text-primary mb-3">Follow Social Media</h4>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <a
                                    href="#"
                                    className="text-secondary hover:text-brand-primary transition-colors text-sm"
                                >
                                    Contact Us
                                </a>
                            </li>
