...
const QuickBooking: React.FC<QuickBookingProps> = () => {
    ...
    const handleBooking = async () => {
        if (!branchId || !movieId || !date || !showtimeId) {
            setNotification({
                message: 'Please select a cinema, movie, date, and showtime before continuing.',
                type: 'info'
            })
            return
        }
    ...
    useEffect(() => {
        ...
        setNotification({
            message: 'Unable to load cinema list right now. Please try again shortly.',
            type: 'error'
        })
    }, [branchesError])
                                ...
                                >
                                    ...
                                    <div className="relative">
                                        <select
                                            value={branchId || ''}
                                            onChange={(e) =>
                                                autoNavigate('branchId', e.target.value)
                                            }
                                        ...
                                        >
                                            ...
                                            {branchesError ? (
                                                <option
                                                    value=""
                                                    className="bg-[#1a2232] text-red-400"
                                                >
                                ...
                                >
                                    ...
                                    <div className="relative">
                                        <select
                                            value={movieId || ''}
                                            onChange={(e) =>
                                                autoNavigate('movieId', e.target.value)
                                            }
                                        ...
                                        >
                                            ...
                                            {!branchId ? (
                                                <option
                                                    value=""
                                                    className="bg-[#1a2232] text-gray-500"
                                                >
                                ...
                                >
                                    ...
                                    <div className="relative">
                                        <select
                                            value={showtimeId || ''}
                                            onChange={(e) =>
                                                autoNavigate('showtimeId', e.target.value)
                                            }
                                            className="w-full px-3 py-2.5 bg-[#1a2232] border border-gray-700 rounded-lg text-white text-sm appearance-none cursor-pointer transition-all duration-300 hover:border-[#648ddb]/50 focus:border-[#648ddb] focus:ring-2 focus:ring-[#648ddb]/20 focus:outline-none"
                                        >
                                            <option value="" className="bg-[#1a2232]">
