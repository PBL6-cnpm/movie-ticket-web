...
import { Building, Globe, Mail, MapPin, Phone, Target } from 'lucide-react'
...
const AboutPage = () => {
    ...
    const missionData = [
        {
            icon: Target,
            text: "Contribute to the growth of Vietnam's film, culture, and entertainment market share."
        },
        {
            icon: Globe,
            text: 'Develop the best services at optimal prices, suitable for the income of the Vietnamese people.'
        },
                ...
                <div className="relative h-80 bg-gradient-to-r from-[#242b3d] to-[#1a2232]">
                    <div className="relative container-custom h-full flex flex-col justify-center">
                        ...
                        <p className="text-lg text-gray-300 mt-2 max-w-3xl">
                            Discover our story, our mission, and our commitment to bringing the best
                            cinematic experiences to Vietnam.
                        </p>
                    </div>
                </div>
                        ...
                        <section className="grid md:grid-cols-2 gap-12 items-center">
                            <div>
                                <h2 className="text-3xl font-bold mb-4">
                                    The Nation's Favorite Cinema
                                </h2>
                                <p className="text-gray-300 mb-4">
                                    CineSTECH is one of the most beloved cinema chains in Vietnam,
                                    offering a diverse range of entertainment models. Our goal is to
                                    be the ultimate entertainment destination for every Vietnamese
                                    family.
                                </p>
                                <p className="text-gray-300">
                                    Known as a strong supporter of Vietnamese films, we are
                                    dedicated to contributing to the development of the national
                                    film industry. Alongside international blockbusters, CineSTECH
                                    proudly partners with Vietnamese filmmakers to bring unique
                                    local cinematic works closer to the audience.
                                </p>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 items-center">
                                <div className="p-10">
                                    ...
                                    <p className="text-gray-400 mt-2 mb-6">
                                        Get in touch with our main office.
                                    </p>
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span>
                                                135 Hai Ba Trung, Saigon, Ward Ben Nghe, District 1,
                                                HCMC
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div className="h-56 md:h-[520px]">
                                    <img
                                        src="/mainx.jpeg"
                                        alt="Office Building"
                                        className="w-full h-full object-cover"
